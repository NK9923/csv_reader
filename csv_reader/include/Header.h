...
namespace csv_Reader {
    __declspec(dllimportexport) std::vector<std::vector<std::variant<int, double, std::string>>> readcsv(const std::string& file_name, size_t& csvLineCount, bool skipFirstColumn = true, char delimiter = ',');
